...
cartela = {'regra_simples': {1:-2, 2:-1, 3:-1, 4:-1, 5:-1, 6:-1}, 'regra_avancada': {'sem_combinacao': -1, 'quadra':-1, 'full_house':-1, 'sequencia_baixa':-1-1, 'sequencia_alta':-1, 'cinco_iguais':-1}}
